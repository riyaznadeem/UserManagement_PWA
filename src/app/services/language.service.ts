...
export class LanguageService {
  ...
  private readonly translations: Record<Language, Record<string, string>> = {
    en: {
      ...
      "dashboard.deleteUsers": "Delete Users",
      ...
      'userManagement.cannotEditSelf': 'You cannot edit your own account.',
    ...
    ar: {
      ...
      "dashboard.deleteUsers": "المستخدمون المحذوفون",
      ...
      'userManagement.cannotEditSelf': 'لا يمكنك تعديل حسابك الشخصي.',
